...
//x
if (point_in_circle(x + lengthdir_x(spd,point_direction(x,y,o_player.x,o_player.y)),y,o_chainchomp_post.x,o_chainchomp_post.y,post_rad))
{
x += lengthdir_x(spd,point_direction(x,y,o_player.x,o_player.y));
}
//y
if (point_in_circle(x,y + lengthdir_y(spd,point_direction(x,y,o_player.x,o_player.y)),o_chainchomp_post.x,o_chainchomp_post.y,post_rad))
{
...
spd += acc;
//x
if (point_in_circle(x + lengthdir_x(spd,charge_dir),y,o_chainchomp_post.x,o_chainchomp_post.y,post_rad))
{
x += lengthdir_x(spd,charge_dir);
}
//y
if (point_in_circle(x,y + lengthdir_y(spd,charge_dir),o_chainchomp_post.x,o_chainchomp_post.y,post_rad))
{
